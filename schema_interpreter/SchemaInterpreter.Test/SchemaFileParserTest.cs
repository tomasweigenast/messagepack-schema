...
//            ParserContext.Current.AddPackage(new SchemaPackage("test2", 1));
...
//            ParserContext.Current.AddPackage(new SchemaPackage("test3", 1));
...
//            ParserContext.Current.AddPackage(new SchemaPackage("test4", 1));
...
//            ParserContext.Current.AddPackage(new SchemaPackage("test5", 1));
...
//            ParserContext.Current.AddPackage(new SchemaPackage("test6", 1));
...
//            ParserContext.Current.AddPackage(new SchemaPackage("test7", 1));
...
//            ParserContext.Current.AddPackage(new SchemaPackage("test1", 1));
...
//            ParserContext.Current.AddPackage(new SchemaPackage("test8", 1));
...
//            ParserContext.Current.AddPackage(new SchemaPackage("test9", 1));
